                                ...
                                <div>
                                    <form id="addform" class="form-horizontal form-bordered" role="form">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="getName" value="${permission.getName()!}"
                                                       class="form-control" id="getName">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="getMethod"
                                                   class="col-sm-2 control-label no-padding-right">权限方法</label>
                                            <div class="col-sm-10">
                                                <input type="text" value="${permission.getMethod()!}" name="getMethod"
                                                       class="form-control" id="getMethod">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="getDescription"
                                                   class="col-sm-2 control-label no-padding-right">描述</label>
                                            <div class="col-sm-10">
                                                <input type="text" value="${permission.getDescription()!}"
                                                       name="getDescription" class="form-control" id="getDescription">
                                            </div>
                                        </div>
                                        <div class="form-group ">
...
<script type="text/javascript">
    $("#permission_list").click(function () {
        location = "/oa/permission/list.html"
    })
            ...
            $.post(
                    ...
                    function (res) {
                        ...
                        if (res.code == 0) {
                            ...
                            setTimeout(function () {
                                location = "/oa/permission/index.html";
                            }, 1000);
                        }
                    }
            )
