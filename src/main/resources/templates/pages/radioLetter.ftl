                        ...
                        <div class="well with-header with-footer">
                            ...
                            <div style="float:right;margin-right:2px;">
                                ...
                                <div class="form-group">
                                    ...
                                    <#list radioList as c>
                                        <option value="${c.getId()}" <#if c.getId() ==radioId >selected</#if>>
                                            ${c.getRadioName()}</option>
                                    </#list>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="table-scrollable">
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                    <#list pageContent.getPageContent() as radioLetter>
                                    <tr id="${radioLetter.getId()}">
                                        <td>${radioLetter.getRadioName()}</td>
                                        <td>${radioLetter.getLetter()!}</td>
                                        <td>${radioLetter.getUserName()!}</td>
                                        <td>${radioLetter.getTime()!}</td>
                                    </tr>
                                    </#list>
                                    </tbody>
                                </table>
                            ...
                            <div class="margin-top-30 text-align-right">
                                <div class="next">
                                    <ul class="pagination">
                                        <li>
                                            <a href="${url}?page=1&size=${size}&year=${year}&month=${month}&day=${day}&radioId=${radioId}">首页</a>
                                        </li>
                                            <#if currentPage lte 1>
                                                <li class="disabled"><a>上一页</a></li>
                                            <#else>
                                                <li>
                                                    <a href="${url}?page=${currentPage-1}&size=${size}&year=${year}&month=${month}&day=${day}&radioId=${radioId}">上一页</a>
                                                </li>
                         ...
                         <li class="active"><a href="#">${index}</a></li>
                                                       <#else>
                        <li>
                            <a href="${url}?page=${index}&size=${size}&year=${year}&month=${month}&day=${day}&radioId=${radioId}">${index}</a>
                        </li>
                                                       </#if>
                                                   </#list>
                            ...
                            <a href="${url}?page=${index}&size=${size}&year=${year}&month=${month}&day=${day}&radioId=${radioId}">${index}</a>
                                ...
                                <li>
                                    <a href="${url}?page=${index}&size=${size}&year=${year}&month=${month}&day=${day}&radioId=${radioId}">${index}</a>
                                                ...
                                                <#else>
                                                    <li>
                                                        <a href="${url}?page=${currentPage+1}&size=${size}&year=${year}&month=${month}&day=${day}&radioId=${radioId}">下一页</a>
                                                    </li>
                                                </#if>
                                        <li>
                                            <a href="${url}?page=${pageContent.getTotalPages()}&year=${year}&month=${month}&day=${day}&radioId=${radioId}">尾页</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
...
<script>
    ...
    $(function () {
        ...
        $("#e3").change(function () {
            ...
            var radioId = "${radioId}"
            location = "/oa/radio/list/letter?radioId=" + radioId + "&year=" + year + "&month=" + month + "&day=" + day
        })


        $("#radio").change(function () {
            var radioId = $(this).find("option:checked").val();
