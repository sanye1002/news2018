                    ...
                    <div class="col-xs-12 col-md-12">
                        <div class="well with-header with-footer">
                                ...
                                <div class="next">
                                    <ul class="pagination">
                                        <li><a href="${url}?page=1&size=${size}&state=${state}&type=${type}">首页</a></li>
                                            ...
                                            <#else>
                                                <li>
                                                    <a href="${url}?page=${currentPage-1}&size=${size}&state=${state}&type=${type}">上一页</a>
                                                </li>
                         ...
                         <li class="active"><a href="#">${index}</a></li>
                                                       <#else>
                        <li><a href="${url}?page=${index}&size=${size}&state=${state}&type=${type}">${index}</a>
                        </li>
                                                       </#if>
                                                   </#list>
                        ...
                        <li><a href="${url}?page=${index}&size=${size}&state=${state}&type=${type}">${index}</a>
                                ...
                                <li class="active"><a href="#">${index}</a></li>
                                                       <#else>
                                <li>
                                    <a href="${url}?page=${index}&size=${size}&state=${state}&type=${type}">${index}</a>
                                </li>
                                                       </#if>
                                                   </#list>
                                ...
                                <li>
                                    <a href="${url}?page=${index}&size=${size}&state=${state}&type=${type}">${index}</a>
                                                ...
                                                <#else>
                                                    <li>
                                                        <a href="${url}?page=${currentPage+1}&size=${size}&state=${state}&type=${type}">下一页</a>
                                                    </li>
                                                </#if>
                                        <li>
...
<script>
            ...
            $.post(
                    ...
                    function (data) {
                        if (data.code == 0) {
                            ...
                            setTimeout(function () {
                                location = url + search
                                // location = "/oa/article/user/articlelist?type=" + resultType + "&state=" + state
                            }, 100)
                        }
                        if (data.code > 0) {
                            layer.msg(data.message);
    ...
    $("#selectType").change(function () {
        var resultType = $("#type input[type=checkbox]:checked").val()
        var state = $(this).val()
        location = "/oa/article/user/articlelist.html?type=" + resultType + "&state=" + state
    });
    ...
    $("input[type=checkbox]").click(function () {
        ...
        location = "/oa/article/user/articlelist.html?state=" + resultStatus + "&type=" + resultType
