                        ...
                        <div class="widget flat radius-bordered">
                            ...
                            <div class="widget-body col-lg-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <span class="input-icon icon-right">
                                                <select id="e2" style="width:100%;">
                                                    <option value=1
                                                            <#if article.getTypeId()! == 1>selected</#if> >图文</option>
                                                    <option value=2
                                                            <#if article.getTypeId()! == 2>selected</#if> >多图</option>
                                                </select>
                                                <i class="glyphicon glyphicon-fire"></i>
                                            </span>
                                        </div>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-12 2" style="display: none">
